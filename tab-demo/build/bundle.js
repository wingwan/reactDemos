...
/***/ function(module, exports, __webpack_require__) {
	...
	var data = [{ name: 'tab1', value: 'red', content: 'I am content1' }, { name: 'tab2', value: 'blue', content: 'I am content2' }, { name: 'tab3', value: 'yellow', content: 'I am content3' }, { name: 'tab4', value: 'green', content: 'I am content4' }, { name: 'tab5', value: 'White', content: 'I am content5' }];
	    ...
	    render: function render() {
	        var tabs = this.props.data.map(function (item) {
	            ...
	            return React.createElement(
	                'li',
	                { 'data-value': item.value, className: selected, onClick: this.handleOnClick },
	                item.name
	            );
	        }, this);
	        ...
	        var cnts = this.props.data.map(function (item) {
	            ...
	            return React.createElement(
	                'li',
	                { 'data-value': item.value, className: active },
	                item.content
	            );
	        }, this);
	...
	React.render(TabSelector({ label: '', data: data, selected: 'red' }), document.getElementById('container'));
